    ...
    implements Job
{
    ...
    
    {
        ...
        {
            throw new AlfrescoRuntimeException(JOB_DATA_PARAMETER_NAME_WEB_PROJECT_DEPLOYMENT_SERVICE + " must be provided and must be a reference to an instance of org.alfresco.extension.deployment.WebProjectDeploymentService.");
        }
